...
public final class Encoder implements Visitor {
  ...
  public Object visitSequentialDeclaration(SequentialDeclaration ast, Object o) {
    ...
    //se guarda la dirrecci�n inicial para cuando 
  ...
  private void encodeFetchAddress (Vname V, Frame frame) {
    ...
    public Object visitForFromCommand(ForFromCommand aThis, Object o) {
      //for ID from Exp1
      Frame frame = (Frame) o;
      //visita el identificador (Esta con E para evitar el error, pero deberia estar con aThis.I.visit.. para obtener el tamaño de la variable de control.
      int extraSize = ((int) aThis.E.visit(this, frame)); //Esto no lo está tomando bien, el valor llega nulo como si no existiera el Id
      //salta la evaluacion.
      emit(Machine.PUSHop, 0, 0, extraSize); 
